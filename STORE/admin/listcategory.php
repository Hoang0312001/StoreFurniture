                        ...
                        <table class="table list-table-wp">
                            <thead>
                                <tr>
                                    ...
                                    <td><span class="thead-text">Mã Thể Loại</span></td>
                                    <td><span class="thead-text">Tên Thể Loại</span></td>
                            ...
                            <tbody>
                                <?php
                                 $i=0;
                                 $findCategoryByActivity = $controller->findCategoryByActivity();
                                 $updateCategory = $controller->updateCategory();
                                 $updateCategory = $controller->delCategory(); 
                                 foreach($findCategoryByActivity as $rs)
                                { $i++;?>
                              <form  method="post">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input id="add-new" name = "updatecategory" class="fl-left" style = "width:70px;margin: 0px;border: aquamarine;
                                    ...
                                    <input  id="add-new" type="submit" class="fl-left" style = "width:70px;margin: 0px;border: aquamarine;
                                                             cursor: pointer;text-align: center;"  value = 'Xóa' name = "delcategory" >
                                    </td>
                                </tr>
